 ...
 * The adapter layer (slang-parser.ts) maps these to our plugin-specific
...
export interface AgentMeta {
	 ...
	 *   - `include_subfolder_rules` — recursive project rules-directory scanning
	 *   - `include_mode_rules`      — per-mode rules loading
	 *   - `include_user_rules`      — user rules loading (non-mode)
...
export interface StakeOp extends BaseNode {
	 ...
	 * no I/O. See `slang_specs.md` § Semantic Assertions.
	 */
	where?: Expr
	binding?: string
	/**
