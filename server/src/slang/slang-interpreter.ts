/**
 * Pure-function Slang interpreter — the deterministic workflow VM.
 *
 * Every function in this module takes all state as explicit parameters
 * and has zero dependencies on any host framework, runtime, or editor
 * API. This makes the core VM (advanceAgent, evalExpr, mailbox
